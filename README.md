...
In this lab, we will practice programming fundamentals and implement a prime number
generator. 

To complete this lab, follow the instructions in [lab-01.md](lab-01.md) ([PDF version](lab-01.pdf)). Below you'll find important and useful information about submitting your work, using git, and testing your code. 
